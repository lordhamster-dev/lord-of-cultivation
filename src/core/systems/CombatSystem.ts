import type { CombatAreaDef, EnemyDef } from "../data/enemies";
import { getCombatArea } from "../data/enemies";
import { getEquipmentTotalStats } from "../data/equipment";
import type { CombatState, CombatStats, EquipmentState, Inventory, ItemStack } from "../types";
...
export function getPlayerCombatStats(stageIndex: number, equipment: EquipmentState, combatLevel: number): CombatStats {
