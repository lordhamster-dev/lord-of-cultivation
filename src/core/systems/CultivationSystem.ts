import { getSubStageCount, MAX_STAGE_INDEX, STAGES } from "../data/stages";
 ...
 */
export function getBreakthroughCost(stageIndex: number, hasPill = false): number {
 ...
 */
export function attemptBreakthrough(cultivation: CultivationState, inventory: Inventory): BreakthroughResult {
    if (cultivation.progress < MAX_CULTIVATION_PROGRESS) {
