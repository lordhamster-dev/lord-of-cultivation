    ...
    enemies: [
      {
        ...
        name: '灵兔',
        icon: '🐇',
        hp: 30, attack: 5, defense: 2, exp: 8, spiritStones: 5,
        drops: [
      ...
      },
      {
        ...
        name: '野灵猪',
        icon: '🐗',
        hp: 60, attack: 10, defense: 5, exp: 15, spiritStones: 10,
        drops: [
    ...
    enemies: [
      {
        ...
        name: '洞穴蝙蝠',
        icon: '🦇',
        hp: 150, attack: 25, defense: 10, exp: 40, spiritStones: 30,
        drops: [
      ...
      },
      {
        ...
        name: '岩石傀儡',
        icon: '🗿',
        hp: 300, attack: 35, defense: 25, exp: 80, spiritStones: 60,
        drops: [
    ...
    enemies: [
      {
        ...
        name: '火焰蛇',
        icon: '🐍',
        hp: 800, attack: 80, defense: 40, exp: 200, spiritStones: 200,
        drops: [
      ...
      },
      {
        ...
        name: '熔岩兽',
        icon: '🌋',
        hp: 1500, attack: 120, defense: 70, exp: 400, spiritStones: 400,
        drops: [
    ...
    enemies: [
      {
        ...
        name: '虚空幻影',
        icon: '👻',
        hp: 5000, attack: 300, defense: 150, exp: 1000, spiritStones: 1500,
        drops: [
      ...
      },
      {
        ...
        name: '上古妖魔',
        icon: '👹',
        hp: 10000, attack: 500, defense: 250, exp: 2500, spiritStones: 3000,
        drops: [
