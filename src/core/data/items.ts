...
export const PILL_COMBAT_EFFECTS: Record<string, PillCombatEffect> = {
    gathering_pill: { hpRecovery: 0.05, spiritRecovery: 0.3 },
    foundation_pill: { hpRecovery: 0.15, spiritRecovery: 0.05 },
    core_formation_pill: { hpRecovery: 0.2, spiritRecovery: 0.1 },
    nascent_soul_pill: { hpRecovery: 0.25, spiritRecovery: 0.15 },
    god_transform_pill: { hpRecovery: 0.3, spiritRecovery: 0.2 },
    void_refining_pill: { hpRecovery: 0.35, spiritRecovery: 0.25 },
    body_integration_pill: { hpRecovery: 0.4, spiritRecovery: 0.3 },
    mahayana_pill: { hpRecovery: 0.5, spiritRecovery: 0.4 },
    true_immortal_pill: { hpRecovery: 0.6, spiritRecovery: 0.5 },
    golden_immortal_pill: { hpRecovery: 0.7, spiritRecovery: 0.6 },
    taiyi_pill: { hpRecovery: 0.8, spiritRecovery: 0.7 },
    daluo_pill: { hpRecovery: 0.9, spiritRecovery: 0.8 },
    dao_ancestor_pill: { hpRecovery: 1.0, spiritRecovery: 1.0 },
};
