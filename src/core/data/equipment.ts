...
export const EQUIPMENT: EquipmentDef[] = [
  ...
  },
  {
    ...
    requiredStage: 1,
    forgingRecipe: {
      ingredients: [{ itemId: 'demon_core', quantity: 3 }, { itemId: 'beast_bone', quantity: 5 }],
      spiritStones: 500,
  ...
  // ─── Helmet (头盔) ──────────────────────────────────────────────────
  {
    ...
    requiredStage: 0,
    forgingRecipe: {
      ingredients: [{ itemId: 'iron_ore', quantity: 2 }, { itemId: 'beast_hide', quantity: 1 }],
      spiritStones: 40,
  ...
  },
  {
    ...
    requiredStage: 1,
    forgingRecipe: {
      ingredients: [{ itemId: 'iron_ore', quantity: 5 }, { itemId: 'demon_core', quantity: 2 }],
      spiritStones: 350,
  ...
  // ─── Amulet (护身符) ────────────────────────────────────────────────
  {
    ...
    requiredStage: 0,
    forgingRecipe: {
      ingredients: [{ itemId: 'beast_bone', quantity: 2 }, { itemId: 'beast_hide', quantity: 3 }],
      spiritStones: 60,
  ...
  // ─── Gloves (手套) - left & right ──────────────────────────────────
  {
    ...
    requiredStage: 0,
    forgingRecipe: {
      ingredients: [{ itemId: 'iron_ore', quantity: 2 }, { itemId: 'beast_hide', quantity: 2 }],
      spiritStones: 45,
  ...
  },
  {
    ...
    requiredStage: 1,
    forgingRecipe: {
      ingredients: [{ itemId: 'iron_ore', quantity: 6 }, { itemId: 'demon_core', quantity: 2 }],
      spiritStones: 400,
  ...
  },
  {
    ...
    requiredStage: 2,
    forgingRecipe: {
      ingredients: [{ itemId: 'fire_crystal', quantity: 3 }, { itemId: 'iron_ore', quantity: 8 }],
      spiritStones: 3500,
  ...
  },
  {
    ...
    requiredStage: 3,
    forgingRecipe: {
      ingredients: [{ itemId: 'void_crystal', quantity: 3 }, { itemId: 'iron_ore', quantity: 12 }],
      spiritStones: 45000,
  ...
  // ─── Rings (戒指) - left & right ───────────────────────────────────
  {
    ...
    requiredStage: 0,
    forgingRecipe: {
      ingredients: [{ itemId: 'beast_bone', quantity: 2 }, { itemId: 'iron_ore', quantity: 1 }],
      spiritStones: 50,
      forgingLevelRequired: 3,
      exp: 12,
    },
  ...
  },
  {
    ...
    requiredStage: 2,
    forgingRecipe: {
      ingredients: [{ itemId: 'fire_crystal', quantity: 2 }, { itemId: 'iron_ore', quantity: 5 }],
      spiritStones: 3000,
  ...
  },
  {
    ...
    requiredStage: 3,
    forgingRecipe: {
      ingredients: [{ itemId: 'void_crystal', quantity: 3 }, { itemId: 'demon_core', quantity: 5 }],
      spiritStones: 60000,
  ...
  // ─── Boots (靴子) ──────────────────────────────────────────────────
  {
    ...
    requiredStage: 0,
    forgingRecipe: {
      ingredients: [{ itemId: 'beast_hide', quantity: 4 }, { itemId: 'beast_bone', quantity: 1 }],
      spiritStones: 35,
      forgingLevelRequired: 2,
      exp: 10,
    },
  },
  {
    ...
    requiredStage: 1,
    forgingRecipe: {
      ingredients: [{ itemId: 'beast_hide', quantity: 8 }, { itemId: 'demon_core', quantity: 1 }],
      spiritStones: 300,
