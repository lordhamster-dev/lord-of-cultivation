...
export const TECHNIQUES: TechniqueDef[] = [
    ...
    },
    {
        ...
        icon: "💫",
        spiritCostPerSec: 0,
        effects: [{ type: "meditation", multiplier: 1.5 }],
        requiredStage: 0,
    },
    {
    ...
    },
    {
        ...
        icon: "🌟",
        spiritCostPerSec: 0,
        effects: [{ type: "meditation", multiplier: 2.0 }],
        requiredStage: 2, // 金丹
    },
    {
        id: "nascent_soul_art",
    ...
    },
    {
        ...
        icon: "⚡",
        spiritCostPerSec: 0,
        effects: [{ type: "meditation", multiplier: 2.5 }],
        requiredStage: 4, // 化神
    },
    {
    ...
    },
    {
        ...
        icon: "☀️",
        spiritCostPerSec: 0,
        effects: [{ type: "meditation", multiplier: 4.0 }],
        requiredStage: 7, // 大乘
    },
    {
