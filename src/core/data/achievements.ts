...
export const ACHIEVEMENTS: AchievementDef[] = [
    ...
    {
        id: "reach_void_refining",
        name: "炼虚入道",
        description: "突破至炼虚期，踏入中境界",
        icon: "🌌",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 5,
    },
    {
        id: "reach_body_integration",
        name: "合体圆融",
        description: "突破至合体期",
        icon: "☯️",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 6,
    },
    {
        id: "reach_mahayana",
        name: "大乘法成",
        ...
        icon: "🌟",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 7,
    },
    {
        id: "reach_true_immortal",
        name: "飞升真仙",
        description: "突破至真仙境，踏入上境界",
        icon: "✨",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 8,
        isHidden: true,
    },
    {
        id: "reach_golden_immortal",
        name: "金仙大道",
        description: "突破至金仙境",
        icon: "🏅",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 9,
        isHidden: true,
    },
    {
        id: "reach_dao_ancestor",
        name: "道祖之尊",
        description: "突破至道祖境，大道唯一",
        icon: "👑",
        category: "cultivation",
        condition: (s) => s.cultivation.stageIndex >= 12,
        isHidden: true,
    },
    {
        id: "use_technique",
