                ...
                enemies: [
                    {
                        ...
                        exp: 10,
                        spiritStones: 8,
                        drops: [{ itemId: "beast_hide", chance: 0.5, quantity: [1, 2] }],
                    },
                    {
                        id: "cave_spider",
                        name: "洞穴蜘蛛",
                        ...
                        exp: 12,
                        spiritStones: 10,
                        drops: [{ itemId: "beast_hide", chance: 0.4, quantity: [1, 1] }],
                    },
                ],
            },
            {
                ...
                enemies: [
                    {
                        ...
                        exp: 20,
                        spiritStones: 15,
                        drops: [{ itemId: "beast_bone", chance: 0.4, quantity: [1, 2] }],
                    },
                ],
            },
            {
                ...
                enemies: [
                    {
                        ...
                        exp: 50,
                        spiritStones: 40,
                        drops: [{ itemId: "demon_core", chance: 0.3, quantity: [1, 1] }],
                    },
                    {
                        id: "demon_mage",
                        name: "妖魔法师",
                        ...
                        exp: 60,
                        spiritStones: 50,
                        drops: [{ itemId: "demon_core", chance: 0.35, quantity: [1, 1] }],
                    },
                ],
            },
            {
                ...
                enemies: [
                    {
                        ...
                        drops: [
                            ...
                            { itemId: "demon_core", chance: 0.4, quantity: [1, 2] },
                        ],
                    },
                ],
            },
                ...
                enemies: [
                    {
                        ...
                        exp: 250,
                        spiritStones: 200,
                        drops: [{ itemId: "iron_ore", chance: 0.5, quantity: [2, 5] }],
                    },
                ],
            },
            {
