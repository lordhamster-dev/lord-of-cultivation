...
import { QUEST_POOL, getTodayString } from '../../core/data/quests';
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {def.reward.items?.map(item => {
                  ...
                  return (
                    <span key={item.itemId} className="text-xs bg-slate-700 text-slate-300 px-2 py-0.5 rounded">
